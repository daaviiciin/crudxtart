...
public class ClienteTest {
    ...
    public void testClienteRepository() {
        ...
        cliente.setEmail("cliente.test@example.com");
        ...
        creado.setNombre("Cliente Test Actualizado");
        clienteService.updateCliente(creado);

        clienteService.deleteCliente(creado.getId_cliente());
    }
}
